 ...
 */
add_filter( 'template_include', array( 'Tourizto_Wrapping', 'wrap' ), 99 );
add_filter( 'tourizto_wrap_base', 'tourizto_wrap_base_cpts' );
 ...
 */
function tourizto_template_path() {
	return Tourizto_Wrapping::$main_template;
}
 ...
 */
function tourizto_template_base() {
	return Tourizto_Wrapping::$base;
}

if ( ! class_exists( 'Tourizto_Wrapping' ) ) {
	...
	class Tourizto_Wrapping {
		...
		/**
		 * Initialize new instance of Tourizto_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'tourizto_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Tourizto_Wrapping class.
		 *
		 * @since 1.0.0
 ...
 */
function tourizto_wrap_base_cpts( $templates ) {
