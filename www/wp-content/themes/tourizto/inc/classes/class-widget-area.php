...
if ( ! class_exists( 'Tourizto_Widget_Area' ) ) {

	/**
	 * Class Tourizto_Widget_Area.
	 */
	class Tourizto_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'tourizto_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'tourizto_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'tourizto_widget_area_classes', $classes, $area_id );
	 ...
	 * @return object
	 */
	function tourizto_widget_area() {
		return Tourizto_Widget_Area::get_instance();
	}

	tourizto_widget_area();
}
